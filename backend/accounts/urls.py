...
from backend.accounts.views import RegisterView, LogoutView, UserProfileView
...
urlpatterns = [
    ...
    # path('change-password/', change_password, name='change_password'), # POST /change-password
]
